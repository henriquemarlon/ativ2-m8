...
from intelligible.subscriber import Subscriber
...
def main(args=None):
    ...
    theseus_node = TheseusShip(navigator_controller)
    rclpy.spin(theseus_node)
    theseus_node.destroy()
    rclpy.shutdown()
